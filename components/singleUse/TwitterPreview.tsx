...
const TwitterPreview = ({username, avatar, domain, embed}: TwitterPreviewProps) => (
	<div className='bg-black p-3 rounded-md flex items-center justify-center'>
		<div className='bg-[#1F2937] w-[90%] rounded-xl p-4'>
			...
			<div>
				<p className='text-blue-500 font-semibold my-2 hover:underline'>https://{domain ?? 'meteor.host'}/u/erwye789</p>
				<img className='max-h-[50vh] cursor-pointer rounded-2xl shadow-sm' src='https://source.unsplash.com/collection/256443?91' />
